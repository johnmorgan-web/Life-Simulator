export const stockMarketAssets = [
  { ticker: 'AAPL', company: 'Apple', sector: 'Technology', basePrice: 260.72, volatility: 0.08, drift: 0.01, icon: '📱' },
  { ticker: 'MSFT', company: 'Microsoft', sector: 'Technology', basePrice: 405.76, volatility: 0.07, drift: 0.01, icon: '💻' },
  { ticker: 'NVDA', company: 'NVIDIA', sector: 'Semiconductors', basePrice: 184.76, volatility: 0.14, drift: 0.012, icon: '🧠' },
  { ticker: 'AMZN', company: 'Amazon', sector: 'Consumer', basePrice: 214.34, volatility: 0.1, drift: 0.008, icon: '📦' },
  { ticker: 'KO', company: 'Coca-Cola', sector: 'Consumer Staples', basePrice: 77.88, volatility: 0.045, drift: 0.004, icon: '🥤' },
  { ticker: 'JPM', company: 'JPMorgan', sector: 'Financials', basePrice: 288.73, volatility: 0.065, drift: 0.005, icon: '🏦' },
  { ticker: 'XOM', company: 'ExxonMobil', sector: 'Energy', basePrice: 148.13, volatility: 0.09, drift: 0.003, icon: '🛢️' },
  { ticker: 'VTI', company: 'US Total Market ETF', sector: 'ETF', basePrice: 333.57, volatility: 0.05, drift: 0.006, icon: '🧺' },
  { ticker: 'TSLA', company: 'Tesla', sector: 'Automotive', basePrice: 399.25, volatility: 0.12, drift: 0.015, icon: '🚗' },
  { ticker: 'GOOGL', company: 'Alphabet', sector: 'Technology', basePrice: 307.04, volatility: 0.09, drift: 0.01, icon: '🔍' },
  { ticker: 'META', company: 'Meta Platforms', sector: 'Technology', basePrice: 653.91, volatility: 0.11, drift: 0.008, icon: '👓' },
  { ticker: 'NFLX', company: 'Netflix', sector: 'Communication Services', basePrice: 96.94, volatility: 0.13, drift: 0.007, icon: '📺' },
  { ticker: 'DIS', company: 'Disney', sector: 'Communication Services', basePrice: 101.32, volatility: 0.1, drift: 0.005, icon: '🏰' },
  { ticker: 'SPY', company: 'S&P 500 ETF', sector: 'ETF', basePrice: 677.05, volatility: 0.04, drift: 0.005, icon: '📈' },
  { ticker: 'QQQ', company: 'Nasdaq 100 ETF', sector: 'ETF', basePrice: 607.73, volatility: 0.06, drift: 0.007, icon: '📊' },
  { ticker: 'DIA', company: 'Dow Jones ETF', sector: 'ETF', basePrice: 477.74, volatility: 0.05, drift: 0.006, icon: '📉' },
]
