...
const transitOptions: TransitOption[] = [
    ...
    // L2 - Public Transport
    { n: 'L2 - Bus Pass', c: 95, l: 2, subText: "Public transit is a great option if it's available in your city, and can save you a lot of money compared to owning a car" },
    
    // L3 - Rideshare
    { n: 'L3 - Uber/Lyft', c: 200, l: 3, subText: "Ridesharing services can be a convenient and cost-effective option for those who don't need a car on a daily basis, but costs can add up if used frequently" },
