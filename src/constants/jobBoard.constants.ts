...
const jobBoard: Job[] = [
  ...
  { title: 'Bank Teller', base: 1900, req: 'HS Diploma', certReq: null, tReq: 3, odds: 0.7, cat: 'Entry' },
  ...
  { title: 'Ultra Wealthy Millionaire', base: 5000000, req: 'Flight School', certReq: 'Rotorcraft Category Rating',  tReq: 5, odds: 0.005, cat: 'Pro' },
]
