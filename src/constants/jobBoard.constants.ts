...
const jobBoard: Job[] = [
  ...
  { title: 'Electrician', base: 2900, req: 'Trade Cert', certReq: null, tReq: 3, odds: 0.7, cat: 'Skilled' },
  { title: 'HVAC Tech', base: 2750, req: 'Trade Cert', certReq: 'HVAC', tReq: 3, odds: 0.75, cat: 'Skilled' },
  { title: 'Plumber', base: 3100, req: 'Trade Cert', certReq: null, tReq: 3, odds: 0.65, cat: 'Skilled' },
  ...
  { title: 'Cosmetologist', base: 2200, req: 'Trade Cert', certReq: null, tReq: 1, odds: 0.8, cat: 'Skilled' },
  ...
  { title: 'Accountant', base: 5400, req: 'Bachelors Degree', certReq: null, tReq: 2, odds: 0.55, cat: 'Pro' },
  { title: 'Civil Engineer', base: 6200, req: 'Bachelors Degree', certReq: 'Architectural Drafter', tReq: 3, odds: 0.4, cat: 'Pro' },
  { title: 'Graphic Designer', base: 4500, req: 'Bachelors Degree', certReq: null, tReq: 1, odds: 0.6, cat: 'Pro' },
  ...
  { title: 'Lab Researcher', base: 5100, req: 'Bachelors Degree', certReq: null, tReq: 2, odds: 0.4, cat: 'Pro' },
  { title: 'Social Worker', base: 4200, req: 'Bachelors Degree', certReq: null, tReq: 2, odds: 0.7, cat: 'Pro' },
  ...
  { title: 'Court Reporter', base: 4500, req: null, certReq: 'Court Reporter', tReq: 2, odds: 0.5, cat: 'Pro' },
  { title: 'Personal Trainer', base: 2800, req: null, certReq: 'Personal Training', tReq: 1, odds: 0.75, cat: 'Pro' },
]
