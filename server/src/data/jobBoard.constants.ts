...
/**
 * SIMPLIFIED JOB BOARD - ~165 jobs organized into 9 clear career tracks
 * 
 * Key Improvements:
 * - Removed 30+ nonsensical prerequisites (Janitor no longer needs Plumbing Design)
 * - Fixed all financial progressions (prerequisites now pay less than targets)
 * - Made military elite achievable (0.1-0.3 odds vs 0.0001)
 * - Consolidated 8+ duplicate jobs
 * - Reduced total jobs from 238 → ~165 (-31%)
...
const jobBoard: Job[] = [
  ...
  { title: 'Security Guard', base: 1400, req: 'HS Diploma', certReq: 'Cybersecurity', tReq: 2, odds: 0.75, cat: 'Entry', subcat: 'General' },
  { title: 'Mail Sorter', base: 1650, req: 'HS Diploma', certReq: 'Customer Service', tReq: 2, odds: 0.7, cat: 'Entry', subcat: 'General' },
  ...
  { title: 'Freelance Writer', base: 2500, req: null, certReq: 'Public Relations', tReq: 3, odds: 0.6, cat: 'Entry', subcat: 'Creative' },
  ...
  { title: 'Hotel Housekeeper', base: 1700, req: 'HS Diploma', certReq: 'Customer Service', tReq: 2, odds: 0.8, cat: 'Entry', subcat: 'Service' },
  ...
  { title: 'Zookeeper', base: 3200, req: 'HS Diploma', certReq: 'Veterinary Technician', tReq: 2, odds: 0.5, cat: 'Entry', subcat: 'General' },
  ...
  { title: 'Special Forces', base: 5000, req: 'Army Sergeant', certReq: 'Special Forces', tReq: 5, odds: 0.15, cat: 'Military', subcat: 'Infantry' },
  { title: 'Navy SEAL', base: 5200, req: 'Navy Petty Officer', certReq: 'Special Forces', tReq: 5, odds: 0.1, cat: 'Military', subcat: 'Naval' },
  ...
  { title: 'Master Electrician', base: 5000, req: 'Electrician', certReq: 'Electrician', tReq: 4, odds: 0.3, cat: 'Trades', subcat: 'Electrical' },
  ...
  { title: 'Master HVAC', base: 4800, req: 'HVAC Tech', certReq: 'HVAC', tReq: 4, odds: 0.35, cat: 'Trades', subcat: 'HVAC' },
  ...
  { title: 'Master Plumber', base: 5200, req: 'Plumber', certReq: 'Plumbing Design', tReq: 4, odds: 0.25, cat: 'Trades', subcat: 'Plumbing' },
  { title: 'Apprentice Welder', base: 1600, req: null, certReq: 'Welder', tReq: 2, odds: 0.85, cat: 'Trades', subcat: 'Welding' },
  ...
  { title: 'Master Mechanic', base: 4500, req: 'Auto Mechanic', certReq: 'Auto Service', tReq: 3, odds: 0.4, cat: 'Trades', subcat: 'Auto' },
  ...
  { title: 'Cosmetologist', base: 2200, req: null, certReq: 'Massage Therapist', tReq: 2, odds: 0.8, cat: 'Trades', subcat: 'Personal Services' },
  ...
  { title: 'Phlebotomist', base: 2400, req: null, certReq: 'Medical Laboratory Scientist', tReq: 2, odds: 0.7, cat: 'Healthcare', subcat: 'Support' },
  ...
  { title: 'Nurse Practitioner', base: 9800, req: 'Masters Degree', certReq: 'Registered Nurse', tReq: 4, odds: 0.4, cat: 'Healthcare', subcat: 'Nursing' },
  { title: 'Clinical Nurse Specialist', base: 10600, req: 'Masters Degree', certReq: 'Registered Nurse', tReq: 4, odds: 0.36, cat: 'Healthcare', subcat: 'Nursing' },
  { title: 'Physician Assistant', base: 11400, req: 'Masters Degree', certReq: 'Emergency Medical Technician', tReq: 4, odds: 0.35, cat: 'Healthcare', subcat: 'Doctor' },
  { title: 'Speech-Language Pathologist', base: 10200, req: 'Masters Degree', certReq: 'Mental Health Counselor', tReq: 4, odds: 0.36, cat: 'Healthcare', subcat: 'Therapy' },
  { title: 'Genetic Counselor', base: 12000, req: 'Masters Degree', certReq: 'Medical Laboratory Scientist', tReq: 4, odds: 0.32, cat: 'Healthcare', subcat: 'Diagnostic' },
  { title: 'Pharmacist', base: 8000, req: 'Pharmacy School', certReq: 'Pharmacy Technician', tReq: 4, odds: 0.35, cat: 'Healthcare', subcat: 'Pharmacy' },
  { title: 'Physician', base: 15000, req: 'Medical School', certReq: 'Medical School', tReq: 4, odds: 0.3, cat: 'Healthcare', subcat: 'Doctor' },
  { title: 'Surgeon', base: 18000, req: 'Physician', certReq: 'Surgery Certificate', tReq: 4, odds: 0.15, cat: 'Healthcare', subcat: 'Doctor' },
  { title: 'Dentist', base: 9000, req: 'Dental School', certReq: 'Dental Assistant', tReq: 4, odds: 0.3, cat: 'Healthcare', subcat: 'Dental' },
  { title: 'Veterinarian', base: 6200, req: 'Veterinary School', certReq: 'Veterinary Technician', tReq: 4, odds: 0.4, cat: 'Healthcare', subcat: 'Veterinary' },
  { title: 'Psychologist', base: 12200, req: 'PhD', certReq: 'Mental Health Counselor', tReq: 4, odds: 0.16, cat: 'Healthcare', subcat: 'Mental Health' },
  { title: 'Neuroscientist', base: 17000, req: 'PhD', certReq: 'Medical Laboratory Scientist', tReq: 5, odds: 0.1, cat: 'Healthcare', subcat: 'Diagnostic' },
  ...
  { title: 'Software Architect', base: 9000, req: 'Senior Developer', certReq: 'Software Development', tReq: 4, odds: 0.3, cat: 'Technology', subcat: 'Development' },
  ...
  { title: 'Data Analyst', base: 5800, req: 'Bachelors Degree', certReq: 'Google Data Analytics', tReq: 2, odds: 0.45, cat: 'Technology', subcat: 'Data' },
  { title: 'Data Scientist', base: 8500, req: 'Data Analyst', certReq: 'Data Science', tReq: 3, odds: 0.3, cat: 'Technology', subcat: 'Data' },
  { title: 'Machine Learning Engineer', base: 12200, req: 'Masters Degree', certReq: 'Data Science', tReq: 4, odds: 0.36, cat: 'Technology', subcat: 'Data' },
  { title: 'AI Research Scientist', base: 19000, req: 'PhD', certReq: 'Data Science', tReq: 5, odds: 0.09, cat: 'Technology', subcat: 'Data' },
  ...
  { title: 'Cloud Administrator', base: 5500, req: 'Network Technician', certReq: 'AWS Certified Cloud Practitioner', tReq: 3, odds: 0.45, cat: 'Technology', subcat: 'Cloud' },
  { title: 'Cloud Architect', base: 9500, req: 'Cloud Administrator', certReq: 'AWS Certified Solutions Architect', tReq: 4, odds: 0.25, cat: 'Technology', subcat: 'Cloud' },
  { title: 'UI/UX Designer', base: 4800, req: 'Bachelors Degree', certReq: 'Graphic Design', tReq: 2, odds: 0.5, cat: 'Technology', subcat: 'Design' },
  { title: 'Lead Designer', base: 6800, req: 'UI/UX Designer', certReq: null, tReq: 3, odds: 0.4, cat: 'Technology', subcat: 'Design' },

  // ====================
  // FINANCE & BUSINESS
  // ====================
  { title: 'Bookkeeper', base: 2800, req: 'HS Diploma', certReq: 'Tax Preparation', tReq: 2, odds: 0.7, cat: 'Finance', subcat: 'Accounting' },
  ...
  { title: 'Financial Analyst', base: 7000, req: 'Bachelors Degree', certReq: 'Financial Analysis', tReq: 3, odds: 0.35, cat: 'Finance', subcat: 'Analysis' },
  { title: 'Biostatistician', base: 11400, req: 'Masters Degree', certReq: 'Data Science', tReq: 4, odds: 0.34, cat: 'Finance', subcat: 'Analysis' },
  { title: 'Research Economist', base: 16000, req: 'PhD', certReq: 'Financial Analysis', tReq: 5, odds: 0.11, cat: 'Finance', subcat: 'Analysis' },
  ...
  { title: 'Investment Analyst', base: 6500, req: 'Bachelors Degree', certReq: 'Financial Analysis', tReq: 3, odds: 0.4, cat: 'Finance', subcat: 'Investment' },
  ...
  { title: 'Hospitality General Manager', base: 7000, req: 'Hotel Manager', certReq: null, tReq: 4, odds: 0.3, cat: 'Service', subcat: 'Hospitality' },
  ...
  { title: 'University Professor', base: 12500, req: 'PhD', certReq: 'Teaching Certificate', tReq: 4, odds: 0.14, cat: 'Education', subcat: 'Teaching' },
  { title: 'Counselor', base: 4500, req: 'Bachelors Degree', certReq: 'Mental Health Counselor', tReq: 3, odds: 0.5, cat: 'Education', subcat: 'Counseling' },
  { title: 'Clinical Psychologist', base: 13200, req: 'PhD', certReq: 'Mental Health Counselor', tReq: 4, odds: 0.15, cat: 'Education', subcat: 'Psychology' },
  { title: 'Social Worker', base: 4200, req: 'Bachelors Degree', certReq: 'Social Work Case Manager', tReq: 3, odds: 0.7, cat: 'Education', subcat: 'Social Services' },
  ...
  { title: 'Lawyer', base: 9000, req: 'Law School', certReq: 'Paralegal', tReq: 4, odds: 0.2, cat: 'Legal', subcat: 'Law' },
  { title: 'Partner Attorney', base: 15000, req: 'Lawyer', certReq: null, tReq: 4, odds: 0.1, cat: 'Legal', subcat: 'Law' },
  { title: 'Police Officer', base: 4500, req: 'HS Diploma', certReq: 'Cybersecurity', tReq: 3, odds: 0.6, cat: 'Legal', subcat: 'Law Enforcement' },
  { title: 'Detective', base: 6500, req: 'Police Officer', certReq: 'Intelligence Analyst', tReq: 3, odds: 0.4, cat: 'Legal', subcat: 'Law Enforcement' },
  { title: 'Correctional Officer', base: 3200, req: 'HS Diploma', certReq: 'Cybersecurity', tReq: 2, odds: 0.7, cat: 'Legal', subcat: 'Corrections' },
  ...
  { title: 'Business Development', base: 5500, req: 'Sales Rep', certReq: 'Sales', tReq: 3, odds: 0.4, cat: 'Sales', subcat: 'Corporate' },
  ...
  // CREATIVE & MEDIA
  // ====================
  { title: 'Graphic Designer', base: 4500, req: 'Bachelors Degree', certReq: 'Adobe Certified Professional', tReq: 1, odds: 0.4, cat: 'Creative', subcat: 'Design' },
  { title: 'Art Director', base: 6500, req: 'Graphic Designer', certReq: null, tReq: 3, odds: 0.3, cat: 'Creative', subcat: 'Design' },
  { title: 'Content Writer', base: 4000, req: 'Bachelors Degree', certReq: 'Public Relations', tReq: 2, odds: 0.5, cat: 'Creative', subcat: 'Writing' },
  ...
  { title: 'Consultant', base: 7000, req: 'Bachelors Degree', certReq: 'Project Management', tReq: 3, odds: 0.3, cat: 'Executive', subcat: 'Consulting' },
  ...
  { title: 'Tech Startup Founder', base: 50000, req: 'CEO', certReq: 'Entrepreneurship', tReq: 5, odds: 0.0005, cat: 'Easter Egg', subcat: 'Business' },
  { title: 'Millionaire', base: 200000, req: 'Tech Startup Founder', certReq: 'Financial Analysis', tReq: 5, odds: 0.00008, cat: 'Easter Egg', subcat: 'Wealth' },
  { title: 'Billionaire', base: 1000000, req: 'Millionaire', certReq: 'Certified Financial Planner', tReq: 5, odds: 0.00002, cat: 'Easter Egg', subcat: 'Wealth' },
]
