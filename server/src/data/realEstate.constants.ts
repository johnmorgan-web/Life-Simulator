...
export const amenityImpact: Record<string, RealEstateAmenityImpact> = {
  ...
  'ev-charging': {
    ...
    installCost: 24000,
    upgradeTier: 'premium',
    prerequisites: ['parking'],
  },
  'rooftop-lounge': {
    rentBoost: 0.03,
    upkeepRate: 0.0018,
    occupancyBoost: 0.024,
    valueBoost: 0.018,
    installCost: 52000,
    upgradeTier: 'signature',
    prerequisites: ['rooftop', 'security'],
  },
  'smart-thermostat': {
    rentBoost: 0.012,
    upkeepRate: 0.0005,
    occupancyBoost: 0.012,
    valueBoost: 0.007,
    installCost: 5000,
    upgradeTier: 'core',
  },
  ...
  clubhouse: {
    ...
    installCost: 36000,
    upgradeTier: 'premium',
    prerequisites: ['courtyard'],
  },
  'dog-park': {
    rentBoost: 0.014,
    upkeepRate: 0.0008,
    occupancyBoost: 0.016,
    valueBoost: 0.008,
    installCost: 12000,
    upgradeTier: 'core',
    prerequisites: ['pet-friendly'],
  },
  'solar-lighting': {
    rentBoost: 0.009,
    upkeepRate: 0.0003,
  ...
  'conference-center': {
    ...
    installCost: 46000,
    upgradeTier: 'signature',
    prerequisites: ['rooftop', 'fiber-internet'],
  },
  'backup-generator': {
    rentBoost: 0.018,
    upkeepRate: 0.0012,
  ...
  'cold-storage': {
    ...
    installCost: 70000,
    upgradeTier: 'signature',
    prerequisites: ['backup-generator', 'security'],
  },
  'solar-roof': {
    rentBoost: 0.016,
    upkeepRate: 0.0005,
  ...
  'climate-control': {
    ...
    installCost: 28000,
    upgradeTier: 'premium',
    prerequisites: ['smart-thermostat'],
  },
  'covered-loading': {
    rentBoost: 0.013,
    upkeepRate: 0.0007,
  ...
  'equipment-barn': {
    ...
    installCost: 26000,
    upgradeTier: 'premium',
    prerequisites: ['irrigation-upgrade'],
  },
  'solar-pump': {
    rentBoost: 0.012,
    upkeepRate: 0.0003,
    occupancyBoost: 0.009,
    valueBoost: 0.009,
    installCost: 12000,
    upgradeTier: 'core',
    prerequisites: ['irrigation-upgrade'],
  ...
  'fiber-backhaul': {
    ...
    installCost: 38000,
    upgradeTier: 'signature',
    prerequisites: ['fiber-internet'],
  },
  'spa-suite': {
    rentBoost: 0.03,
    upkeepRate: 0.0018,
    occupancyBoost: 0.022,
    valueBoost: 0.018,
    installCost: 54000,
    upgradeTier: 'signature',
    prerequisites: ['gym', 'security'],
  },
  'event-space': {
    rentBoost: 0.027,
    upkeepRate: 0.0016,
    ...
    installCost: 48000,
    upgradeTier: 'signature',
    prerequisites: ['clubhouse', 'security'],
  },
  'smart-room-entry': {
    rentBoost: 0.016,
    upkeepRate: 0.0007,
