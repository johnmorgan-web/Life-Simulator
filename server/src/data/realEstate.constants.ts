...
export const realEstateTemplates: RealEstateTemplate[] = [
  ...
  },
  {
    ...
    renovationCostRate: 0.07,
    renovationMonths: 3,
    amenityOptions: ['security', 'smart-lock', 'parking', 'climate-control', 'covered-loading', 'solar-lighting', 'backup-generator', 'keyless-entry', 'facade-refresh', 'tenant-signage', 'smart-thermostat'],
  },
  {
    id: 'rv-park-40',
    ...
    renovationCostRate: 0.06,
    renovationMonths: 3,
    amenityOptions: ['security', 'playground', 'parking', 'clubhouse', 'laundry-room', 'solar-lighting', 'backup-generator', 'keyless-entry', 'facade-refresh', 'tenant-signage', 'outdoor-seating', 'rooftop', 'fitness-studio', 'smart-lock', 'gym', 'conference-center', 'fiber-internet', 'courtyard']
  },
];
