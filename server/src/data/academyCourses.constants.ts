...
export const academyCourses: AcademyCourse[] = [
  ...
  { n: 'Masters Degree', m: 12, c: 3000, type: 'degree', prereq: 'Bachelors Degree', icon: '🎩' , subcategory: 'Academic Degrees' },
  { n: 'PhD', m: 30, c: 5000, type: 'degree', prereq: 'Masters Degree', icon: '🧑‍🎓' , subcategory: 'Academic Degrees' },
